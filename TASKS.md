...
☐ Vérifier au premier `readyset up` réel que `[set.start_scene].quiet_seconds = 7` suffit — le seuil doit dépasser la cadence du plus bavard des écrivains du journal d'Ableton (HJF_Plugins écrit toutes les 5 s)
